...
def test_checkout(login_fixture_for_all):
    ...
    # Fill user details
    login_fixture_for_all.find_element(By.ID, "first-name").send_keys("Loki")
    login_fixture_for_all.find_element(By.ID, "last-name").send_keys("Asgardian")
    login_fixture_for_all.find_element(By.ID, "postal-code").send_keys("12345")
